...
(function(mod) {
  ...
  CodeMirror.modeInfo = [
    ...
    {name: "CQL", mime: "text/x-cassandra", mode: "common", ext: ["cql"]},
    ...
    {name: "MariaDB SQL", mime: "text/x-mariadb", mode: "common"},
    {name: "Modelica", mime: "text/x-modelica", mode: "modelica", ext: ["mo"]},
    {name: "MS SQL", mime: "text/x-mssql", mode: "common"},
    {name: "MySQL", mime: "text/x-mysql", mode: "common"},
    ...
    {name: "PLSQL", mime: "text/x-plsql", mode: "common"},
    ...
    {name: "SQL", mime: "text/x-common", mode: "common", ext: ["common"]},
    {name: "MariaDB", mime: "text/x-mariadb", mode: "common"},
