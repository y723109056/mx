...
CodeMirror.defineMode("common", function(config, parserConfig) {
  "use strict";
...
(function() {
  ...
  CodeMirror.defineMIME("text/x-common", {
    name: "common",
